...
cd "$(dirname "$0")"
case "${1:-}" in
  aplicar.py|revertir.py|corregir_marcas.py|corregir_traducciones.py|corregir_errata.py) ;;
  *) echo "usage: $0 aplicar.py|revertir.py|corregir_marcas.py|corregir_traducciones.py|corregir_errata.py [flags...]" >&2; exit 2 ;;
esac
