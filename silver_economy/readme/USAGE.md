As an evaluator (internal user with the Silver Economy User group):

1. Open the **Silver Economy** app and go to *My Evaluations*.
...
* Review every evaluation under *Silver Economy > My Evaluations* (managers
  see all companies).
...
* Public information pages are served at `/silver-economy` and
  `/silver-economy/instructions`.
