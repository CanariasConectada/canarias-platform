# Silver Economy Certification

**Versión:** 19.0.2.0.0 | **Licencia:** AGPL-3 | **Autor:** Canarias Conectada

Evaluación y certificación Silver Economy para las empresas del marketplace
de Canarias Conectada, construida sobre la app `survey`. Un cuestionario de
40 preguntas otorga sellos Bronce/Plata/Oro que se muestran en el backend,
en el directorio público y en el microsite de la empresa, con caducidad,
plazos de reintento y recordatorios por correo.

Convive con su módulo gemelo `sustainability`: la lógica compartida sobre
