...
- `static/src/js/lugares_interes_comments.js` - JavaScript
- `views/lugares_interes_templates.xml` - Templates QWeb
- `static/src/css/lugares_interes.scss` - Estilos SCSS
