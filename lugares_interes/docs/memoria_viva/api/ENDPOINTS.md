# API REST - Endpoints de Lugares de Interés
...
**Endpoint**: `GET /lugares-de-interes/comentario/listar`
...
**Ejemplo**:
```bash
curl "https://guanarteme.canariasconectada.es/lugares-de-interes/comentario/listar?lugar_id=2&offset=0&limit=10"
```
...
**Endpoint**: `POST /lugares-de-interes/comentario/enviar`
...
**Endpoint**: `GET /lugares-de-interes`
...
**Endpoint**: `GET /lugares-de-interes/<slug>`

**Autenticación**: Pública

**Ejemplo**:
```bash
curl "https://guanarteme.canariasconectada.es/lugares-de-interes/playa-el-confital"
```
...
**Endpoint**: `POST /lugares-de-interes/like/<lugar_id>`

**Autenticación**: Pública (con cookie de sesión)

**Ejemplo**:
```bash
curl -X POST "https://guanarteme.canariasconectada.es/lugares-de-interes/like/2" \
