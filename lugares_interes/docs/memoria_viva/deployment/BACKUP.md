# Guía de Backup - Lugares de Interés
...
### 2. lugares_interes_module.tar.gz (87 KB)
...
# Backup del módulo
tar -czf $BACKUP_DIR/lugares_interes_module.tar.gz \
  -C /home/odoo/addons lugares_interes
...
su - odoo -c "pg_dump canarias_conectada \
  --table=lugares_interes_comentario \
  --table=lugares_interes_palabra_prohibida \
...
su - odoo -c "psql canarias_conectada -c \"SELECT name, state FROM ir_module_module WHERE name='lugares_interes';\""

# Verificar comentarios
su - odoo -c "psql canarias_conectada -c \"SELECT COUNT(*) FROM lugares_interes_comentario;\""

# Verificar palabras prohibidas
su - odoo -c "psql canarias_conectada -c \"SELECT COUNT(*) FROM lugares_interes_palabra_prohibida;\""
```
...
- Documentación completa: `/home/odoo/addons/lugares_interes/docs/`
