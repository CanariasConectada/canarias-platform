Sustainability evaluation and certification for the companies of the
...
* renders a certification card on the company microsite, including the
  score and up to three highlights (energy saving, waste management,
  eco/local products) matched heuristically against the questionnaire.
...
This module coexists with its twin `silver_economy`: both extend
