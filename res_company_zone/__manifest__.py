...
# License AGPL-3.0 or later (https://www.gnu.org/licenses/agpl).
{
    ...
    "description": """
        ...
        field on the partner): the Settings list, the search box, every
        company dropdown and the company switcher match and show
        "TRADE NAME (Legal Name)", because the legal name is the owner's own
        name for a third of the shops and nobody types it first.
    """,
