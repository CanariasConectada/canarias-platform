/* Memoria Viva - Sistema de Valoración con Estrellas */
(function() {
    'use strict';
    ...
    function initRatingSystem() {
        ...
        function cargarMiValoracion(lugarId) {
            fetch('/memoria-viva/rating/mi-valoracion?lugar_id=' + lugarId, {
                method: 'GET',
        ...
        function enviarValoracion(lugarId, rating) {
            ...
            fetch('/memoria-viva/rating/enviar', {
                method: 'POST',
                headers: {
        ...
        function eliminarValoracion(lugarId) {
            ...
            fetch('/memoria-viva/rating/eliminar', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
