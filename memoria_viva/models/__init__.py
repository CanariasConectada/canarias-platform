...
from . import memoria_viva_historia
from . import memoria_viva_historia_image
from . import memoria_viva_tipo
from . import memoria_viva_categoria
from . import memoria_viva_subcategoria
