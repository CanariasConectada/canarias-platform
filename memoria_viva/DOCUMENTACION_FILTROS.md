# Documentación: Sistema de Filtros - Memoria Viva
...
- ❌ **URL generada:** `/memoria-viva&anio=1980` (falta el `?`)
...
- **Función:** Redirige a `/memoria-viva` limpiando todos los filtros
...
### Controlador (`controllers/memoria_viva_website.py`)
...
### Template (`views/memoria_viva_templates.xml`)
...
<div class="d-flex align-items-center flex-wrap gap-2">
    ...
    <t t-if="search or tipo_filter or categoria_filter or ordenar != 'default' or anio_filter">
        <a href="/memoria-viva" class="btn btn-sm btn-outline-danger ms-1">
...
|-----------|---------------|-----------|
| Sin filtros | `/memoria-viva` | ✅ Solo contador |
...
1. `controllers/memoria_viva_website.py` - Generación de URLs seguras
2. `views/memoria_viva_templates.xml` - Badges y botón quitar filtros
...
**Módulo:** memoria_viva v19.0.1.7.0
