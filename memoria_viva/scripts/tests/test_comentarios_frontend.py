...
# -*- coding: utf-8 -*-
"""
Script de prueba completo para el sistema de comentarios de Memoria Viva
...
MEMORIA_URL = f"{BASE_URL}/memoria-viva"
...
class TestComentarios:
    ...
    def test_10_modelo_comentario_existe(self):
        ...
        return 'memoria.viva.comentario' in self.env.registry
    
    def test_11_modelo_palabra_prohibida_existe(self):
        """Test: Modelo de palabras prohibidas existe"""
        return 'memoria.viva.palabra.prohibida' in self.env.registry
    ...
    def test_13_crear_palabra_prohibida_backend(self):
        ...
        Palabra = self.env['memoria.viva.palabra.prohibida'].sudo()
    ...
    def test_17_configuracion_comentarios(self):
        ...
        Settings = self.env['memoria.viva.settings'].sudo()
