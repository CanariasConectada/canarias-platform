...
# -*- coding: utf-8 -*-
"""
Script de prueba ORM para Memoria Viva
...
def run_tests():
    ...
    try:
        ...
        Lugar = env['memoria.viva.historia']
        ...
        Comentario = env['memoria.viva.comentario']
        ...
        Settings = env['memoria.viva.settings']
