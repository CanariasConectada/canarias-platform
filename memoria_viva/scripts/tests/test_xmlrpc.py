...
# -*- coding: utf-8 -*-
"""
Script de prueba XML-RPC para el módulo Memoria Viva
...
class MemoriaVivaXmlRpcTest:
    """Clase de pruebas XML-RPC para Memoria Viva"""
    ...
    def test_01_crear_lugar(self):
        ...
        self.test_lugar_id = self.call('memoria.viva.historia', 'create', lugar_data)
    ...
    def test_03_buscar_lugares(self):
        ...
        lugares = self.call(
            'memoria.viva.historia', 'search_read',
            [('state', '=', 'approved')],
    ...
    def test_04_actualizar_lugar(self):
        ...
        self.call(
            'memoria.viva.historia', 'write',
            [self.test_lugar_id],
            {'description': 'Descripción actualizada via XML-RPC'}
        )
        
        lugar = self.call('memoria.viva.historia', 'read', self.test_lugar_id, ['description'])[0]
    ...
    def test_05_incrementar_vistas(self):
        ...
        self.call('memoria.viva.historia', 'incrementar_vistas', self.test_lugar_id)
    ...
    def test_06_crear_like(self):
        ...
        like_id = self.call('memoria.viva.like', 'create', like_data)
        print_success(f"Like creado: ID {like_id}")
        
        # Verificar contador
        lugar = self.call('memoria.viva.historia', 'read', self.test_lugar_id, ['like_count'])[0]
    ...
    def test_07_contar_likes(self):
        ...
        count = self.call(
            'memoria.viva.like', 'search_count',
            [('lugar_id', '=', self.test_lugar_id)]
        )
    ...
    def test_08_crear_comentario(self):
        ...
        comentario_id = self.call('memoria.viva.comentario', 'create', comentario_data)
    ...
    def test_09_listar_comentarios(self):
        ...
        comentarios = self.call(
            'memoria.viva.comentario', 'get_comentarios_aprobados',
            self.test_lugar_id
        )
    ...
    def test_10_buscar_comentarios(self):
        ...
        for estado in ['aprobado', 'pendiente', 'rechazado']:
            count = self.call(
                'memoria.viva.comentario', 'search_count',
                [('estado', '=', estado)]
            )
    ...
    def test_11_aprobar_comentario(self):
        ...
        comentario_id = self.call('memoria.viva.comentario', 'create', {
            'lugar_id': self.test_lugar_id,
        ...
        # Aprobar
        self.call('memoria.viva.comentario', 'action_approve', [comentario_id])
        
        comentario = self.call(
            'memoria.viva.comentario', 'read',
    ...
    def test_12_crear_respuesta(self):
        ...
        padre_id = self.call('memoria.viva.comentario', 'create', {
            'lugar_id': self.test_lugar_id,
        ...
        # Crear respuesta
        respuesta_id = self.call('memoria.viva.comentario', 'create', {
            'lugar_id': self.test_lugar_id,
    ...
    def test_13_crear_palabra_prohibida(self):
        ...
        palabra_id = self.call('memoria.viva.palabra.prohibida', 'create', palabra_data)
    ...
    def test_14_listar_palabras_prohibidas(self):
        ...
        palabras = self.call(
            'memoria.viva.palabra.prohibida', 'search_read',
            [('active', '=', True)],
            ['name'], 0, 10
        )
    ...
    def test_15_get_settings(self):
        ...
        settings = self.call('memoria.viva.settings', 'get_settings', self.website_id)
    ...
    def test_16_actualizar_settings(self):
        ...
        config_ids = self.call(
            'memoria.viva.settings', 'search',
            [('website_id', '=', self.website_id)]
        )
        
        if config_ids:
            self.call(
                'memoria.viva.settings', 'write',
                config_ids,
    ...
    def test_17_crear_anuncio(self):
        ...
        anuncio_id = self.call('memoria.viva.anuncio', 'create', anuncio_data)
    ...
    def test_18_listar_anuncios_activos(self):
        ...
        anuncios = self.call(
            'memoria.viva.anuncio', 'search_read',
            [('state', '=', 'active')],
    ...
    def test_20_listar_categorias(self):
        ...
        categorias = self.call(
            'memoria.viva.categoria', 'search_read',
            [], ['name', 'active'], 0, 20
        )
    ...
    def cleanup(self):
        ...
        try:
            if self.test_lugar_id:
                self.call('memoria.viva.historia', 'unlink', [self.test_lugar_id])
...
def main():
    ...
    tester = MemoriaVivaXmlRpcTest(url, db, username, password)
