# Índice de Tests - Memoria Viva

## Tests Unitarios (Odoo)

Ubicación: `/home/odoo/addons/memoria_viva/tests/`

### test_memoria_viva_models.py
**Ruta**: `tests/test_memoria_viva_models.py`
...
./odoo-bin -i memoria_viva -d canarias_conectada --test-enable \
  --test-tags=memoria_viva --stop-after-init
```

---

### test_memoria_viva_comentarios.py
**Ruta**: `tests/test_memoria_viva_comentarios.py`
...
**Ruta**: `tests/test_memoria_viva_website.py`
...
Ubicación: `/home/odoo/addons/memoria_viva/scripts/tests/`
...
**Uso**:
```bash
python3 addons/memoria_viva/scripts/tests/test_xmlrpc.py \
...
**Uso**:
```bash
python3 addons/memoria_viva/scripts/tests/test_orm.py
```
...
Asegurar de usar `--test-enable` y `--test-tags=memoria_viva`.
...
- `/home/odoo/addons/memoria_viva/docs/tests/RESULTADOS.md`
