# Resultados de Tests - Modificaciones Memoria Viva
...
| # | Test | Resultado |
|---|------|-----------|
| 10 | Modelo comentarios existe | ✅ `memoria.viva.comentario` |
| 11 | Modelo palabra prohibida existe | ✅ `memoria.viva.palabra.prohibida` |
...
**Archivo:** `models/memoria_viva_comentario.py`
...
**Archivo:** `controllers/memoria_viva_website.py`
...
**Archivo:** `views/memoria_viva_comentario_views.xml`
...
**Archivo:** `views/memoria_viva_comentario_views.xml`
- Menú definido: `Memoria Viva > Comentarios`
...
- `memoria_viva_module.tar.gz` (87 KB)
