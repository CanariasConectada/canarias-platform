# Resumen Ejecutivo de Cambios - Memoria Viva
...
Implementar un sistema completo de comentarios con moderación para el módulo Memoria Viva, incluyendo:
...
### 1. Modelos de Datos
- ✅ `memoria_viva_comentario` - Comentarios con estados de moderación
- ✅ `memoria_viva_palabra_prohibida` - Lista de palabras filtradas
- ✅ Campos extendidos en `memoria_viva_settings` - Configuración
...
### 3. API REST
- ✅ `GET /memoria-viva/comentario/listar` - Listar comentarios (público)
- ✅ `POST /memoria-viva/comentario/enviar` - Crear comentario (autenticado)
...
| **Archivo demo faltante** | `FileNotFoundError: memoria_viva_demo.xml` | Restaurar desde backup |
...
2. **Base de Datos:**
   - Creadas tablas: `memoria_viva_comentario`, `memoria_viva_palabra_prohibida`
   - Agregadas columnas: `estado`, `contiene_palabras_prohibidas`, etc.
   - Creado grupo: `group_memoria_viva_moderator`
...
| 2026-04-07 05:14 | Archivos del módulo | - | `/home/odoo/backup/memoria_viva_files_20260407_0514XX/` |
